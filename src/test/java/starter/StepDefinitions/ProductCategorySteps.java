...
public class ProductCategorySteps {
    ...
    public void iReceiveValidHTTPResponseCodeForGETIdProductCategory(int ignoredArg0) { getIdProductCategory.iReceiveValidHTTPResponseCodeForGETIdProductCategory();
