...
public class OrderSteps {
    ...
    public void iReceiveValidHTTPResponseCodeForGetAllDataOrder(int ignoredArg0) { getAllOrder.iReceiveValidHTTPResponseCodeForGetAllDataOrder();
    ...
    public void iReceiveAValidHTTPResponseCodeOnTheOrderPOST(int ignoredArg0) { postOrder.iReceiveAValidHTTPResponseCodeOnTheOrderPOST();
    ...
    public void iReceiveValidHTTPResponseCodeForGetIdDataOrder(int ignoredArg0) {
