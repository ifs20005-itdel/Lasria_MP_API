...
public class ProductSteps {
    ...
    public void iReceiveAValidHTTPResponseCodeForGetIdDataProducts(int ignoredArg0) { getIdProduct.iReceiveAValidHTTPResponseCodeForGetIdDataProducts();
    ...
    public void iReceiveValidHTTPResponseCodeInProductsRatingPOST(int ignoredArg0) { postProductRating.iReceiveValidHTTPResponseCodeInProductsRatingPOST();
    ...
    public void iReceiveValidHTTPResponseCodeInProductsCommentPOST(int ignoredArg0) { postProductComment.iReceiveValidHTTPResponseCodeInProductsCommentPOST();
